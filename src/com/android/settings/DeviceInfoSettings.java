...
public class DeviceInfoSettings extends SettingsPreferenceFragment {
    ...
    public static DeviceInfoSettings newInstance(){
        DeviceInfoSettings deviceInfoSettings = new DeviceInfoSettings();
    ...
    public void onCreate(Bundle icicle) {
        ...
        setStringSummary(KEY_BUILD_NUMBER, SystemProperties.get("ro.product.version"));

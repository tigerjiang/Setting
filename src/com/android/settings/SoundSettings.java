...
public class SoundSettings extends SettingsPreferenceFragment implements
    ...
    private CheckBoxPreference mEnablePassThrough;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mEnablePassThrough = (CheckBoxPreference) findPreference(KEY_ENABLE_PASS_THROUGH);
        mEnablePassThrough.setPersistent(false);
        mEnablePassThrough.setChecked(Settings.System.getInt(resolver,
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mVibrateWhenRinging) {
          ...
          else if (preference == mEnablePassThrough) {
